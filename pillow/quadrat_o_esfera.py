...
img = Image.new('RGB', (90*n, 90*n), 'White')
dib = ImageDraw.Draw(img)

for i in range(n):
    for j in range(n):
        if i%2 == 0:
            dib.polygon([(i*180, j*180), (i*180+89, j*180), (i*180+89, j*180+89), (i*180, j*180+89)], 'Black')
        else:
            dib.polygon([((i-1)*180+89, (j-1)*180+89), ((i-1)*180+179, (j-1)*180+89), ((i-1)*180+179, (j-1)*180+179), ((i-1)*180+89, (j-1)*180+179)], 'Black')
            dib.polygon([((i-1)*180+179, (j-1)*180+179), ((i-1)*180+269, (j-1)*180+179), ((i-1)*180+269, (j-1)*180+269), ((i-1)*180+179, (j-1)*180+269)], 'Black')
            dib.polygon([((i-1)*180+269, (j-1)*180+269), ((i-1)*180+359, (j-1)*180+269), ((i-1)*180+359, (j-1)*180+359), ((i-1)*180+269, (j-1)*180+359)], 'Black')
